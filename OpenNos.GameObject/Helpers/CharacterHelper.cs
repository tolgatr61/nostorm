...
namespace OpenNos.GameObject.Helpers
{
    public class CharacterHelper
    {
        ...
        private static void loadSpeedData()
        {
            ...
            _speedData[(int)ClassType.Adventurer] = 15;
            _speedData[(int)ClassType.Swordsman] = 17;
            _speedData[(int)ClassType.Archer] = 18;
            _speedData[(int)ClassType.Magician] = 16;

            _speedData[(int)ClassType.MartialArtist] = 17;
        }
