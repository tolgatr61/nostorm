          ...
          /*  if (attacker.AttackUpgrade > 10)
            ...
            */
            ...
            else
            {
              ...
              // weaponDamage += attacker.Character.Prestige * 50;
            ...
            switch (attacker.AttackUpgrade)
            {
                ...
                case -11:
                    defender.ArmorDefense += defender.ArmorDefense * 3;
                    break;
                case -10:
...
#warning Disabled Critical Rate limit
            ...
            if (defender.MapMonster != null && totalDamage > 5)
            {
                if (defender.MapMonster.MonsterVNum == 2619)
                {
                    totalDamage = 300;
                }

                if (defender.MapMonster.MonsterVNum == 2609)
                {
                    totalDamage = 300;
                }
                if (defender.MapMonster.MonsterVNum == 755)
                {
                    totalDamage = 300;
                }
            }
