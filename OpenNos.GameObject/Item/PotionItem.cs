...
namespace OpenNos.GameObject
{
    public class PotionItem : Item
    {
        ...
        public override void Use(ClientSession session, ref ItemInstance inv, byte Option = 0, string[] packetsplit = null)
        {
            ...
            // Arene Normal interdiction de potion
            if (session.CurrentMapInstance.Equals(ServerManager.GetMapInstanceByMapId(2006)) && (inv.ItemVNum == 1242 || inv.ItemVNum == 1243 || inv.ItemVNum == 1246 || inv.ItemVNum == 1244 || inv.ItemVNum == 5582 || inv.ItemVNum == 5583 || inv.ItemVNum == 5584))
            {
                return;
            }

            // Arene Famille interdiction de potion
