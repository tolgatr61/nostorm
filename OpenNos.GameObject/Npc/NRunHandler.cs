        ...
        public static void NRun(ClientSession Session, NRunPacket packet)
        {
            ...
            switch (packet.Runner)
            {
                case 1:
                    ...
                    {
                        Session.Character.Inventory.AddNewToInventory((short)(4 + (packet.Type * 14)), 1, InventoryType.Wear, 5, 5);
                        Session.Character.Inventory.AddNewToInventory((short)(81 + (packet.Type * 13)), 1, InventoryType.Wear, 5, 5);

                        switch (packet.Type)
                        {
                            case 1:
                                Session.Character.Inventory.AddNewToInventory(901, 1, InventoryType.Equipment);
                                Session.Character.Inventory.AddNewToInventory(68, 1, InventoryType.Wear);

                                break;

                            case 2:
                                Session.Character.Inventory.AddNewToInventory(903, 1, InventoryType.Equipment);
                            ...
                            case 3:
                                Session.Character.Inventory.AddNewToInventory(905, 1, InventoryType.Equipment);
                ...
                case 8000:
                    {
                        ...
                        if (packet.Type == 1)
                        {
                            Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY);
                            ...
                            if (Session.Character.Inventory.CountItem(2124) >= 1)
                            {
                                if (itemInstance != null && itemInstance.Upgrade == 10)
                                {
                                    if (Session.Character.Gold < 300000000)
                                    {
                                        Session.SendPacket(Session.Character.GenerateSay("You must have at least 300kk", 11));
                                        return;
                                    }
                                    Session.Character.Gold -= 300000000;
                                    Session.Character.Inventory.RemoveItemAmount(2124, 1);
                                    if (rn <= 20)
                                    {
                                        itemInstance.Upgrade = 11;

                                        Session.SendPacket(UserInterfaceHelper.GenerateGuri(19, 1, Session.Character.CharacterId, 1324));
                                        ServerManager.Shout("The Player " + Session.Character.Name + " managed to upgrade " + itemInstance.Item.Name + " to +11", false);
                                        Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY);
                                    }
                                    if (rn >= 20 && rn <= 50)
                                    {
                                        itemInstance.Upgrade = 9;
                                        Session.SendPacket(UserInterfaceHelper.GenerateGuri(19, 1, Session.Character.CharacterId, 1324));
                                        Session.SendPacket(Session.Character.GenerateSay("Your equipment got downgraded to +9", 11));
                                    }
                                    else
                                    {
                                        Session.SendPacket(UserInterfaceHelper.GenerateGuri(19, 1, Session.Character.CharacterId, 1324));
                                ...
                                {
                                    Session.SendPacket(Session.Character.GenerateSay("You must have a +10 equipment part in your first slot in the Inventory", 11));
                                    return;
                                }
                            ...
                            {
                                Session.SendPacket(Session.Character.GenerateSay("Not enough hearts of the hell, you need at least 1", 11));
                                return;
                            }
                        }
                        ...
                        {
                            int UpgradeItem = 1212;
                            Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY);
                            ItemInstance itemInstance = Session.Character.Inventory.LoadBySlotAndType(0, InventoryType.Equipment);
                            int rn = ServerManager.RandomNumber();
                            if (Session.Character.Inventory.CountItem(UpgradeItem) >= 1)
                            {
                                if (itemInstance != null && itemInstance.Item.VNum == 10080)
                                {
                                    Session.Character.Inventory.RemoveItemAmount(UpgradeItem);
                                    if (rn <= 20)
                                    {
                                        Session.Character.Inventory.RemoveItemAmount(vnum: 10080);
                                        Session.SendPacket(UserInterfaceHelper.GenerateGuri(19, 1, Session.Character.CharacterId, 1324));
                                        Session.Character.Inventory.AddNewToInventory(vnum: 10081, Rare: 6);
                                        Session.SendPacket(Session.Character.GenerateSay("Upgraded to rare", 10));
                                        Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY);
                                    }
                                    else
                                    {
                                        Session.SendPacket(Session.Character.GenerateSay("Fail", 11));
                                    }
                                }


                                if (itemInstance != null && itemInstance.Item.VNum == 10081)
                                {
                                    Session.Character.Inventory.RemoveItemAmount(UpgradeItem);
                                    if (rn <= 10)
                                    {

                                        Session.Character.Inventory.RemoveItemAmount(vnum: 10081);
                                        Session.SendPacket(UserInterfaceHelper.GenerateGuri(19, 1, Session.Character.CharacterId, 1324));
                                        Session.Character.Inventory.AddNewToInventory(vnum: 10082, Rare: 7);
                                        Session.SendPacket(Session.Character.GenerateSay("Upgraded to legendary", 10));
                                        Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY);
                                    }
                                    else
                                    {
                                ...
                                if (itemInstance != null && itemInstance.Item.VNum == 10077)
                                {
                                    Session.Character.Inventory.RemoveItemAmount(UpgradeItem);
                                    if (rn <= 20)
                                    {

                                        Session.Character.Inventory.RemoveItemAmount(vnum: 10077);
                                        Session.SendPacket(UserInterfaceHelper.GenerateGuri(19, 1, Session.Character.CharacterId, 1324));
                                        Session.Character.Inventory.AddNewToInventory(vnum: 10078, Rare: 6);
                                        Session.SendPacket(Session.Character.GenerateSay("Upgraded to rare", 10));
                                        Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY);
                                    }
                                    else
                                ...
                                if (itemInstance != null && itemInstance.Item.VNum == 10078)
                                {
                                    Session.Character.Inventory.RemoveItemAmount(UpgradeItem);
                                    if (rn <= 20)
                                    {

                                        Session.Character.Inventory.RemoveItemAmount(vnum: 10078);
                                        Session.SendPacket(UserInterfaceHelper.GenerateGuri(19, 1, Session.Character.CharacterId, 1324));
                                        Session.Character.Inventory.AddNewToInventory(vnum: 10079, Rare: 7);
                                        Session.SendPacket(Session.Character.GenerateSay("Upgraded to legendary", 10));
                                        Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY);
                                    }
                                    else
                                ...
                                {
                                    Session.SendPacket(Session.Character.GenerateSay("You must have an artifact in your first slot in the Inventory", 11));
                                    return;
                            ...
                            {
                                Session.SendPacket(Session.Character.GenerateSay("Not enough you need at least 1", 11));
                                Console.WriteLine("worked55");
                                return;
                        ...
                        {
                            Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY); //TODO: Excuse
                            ItemInstance itemInstance = Session.Character.Inventory.LoadBySlotAndType(0, InventoryType.Equipment);
                            if (itemInstance != null && itemInstance.Rare == 9)
                            {
                                if (Session.Character.Gold >= 50000000)
                                {
                                    Session.Character.Gold -= 50000000;
                                    Session.SendPacket(UserInterfaceHelper.GenerateGuri(19, 1, Session.Character.CharacterId, 1324));
                                    itemInstance.Rare = 0;
                                    Session.CurrentMapInstance.Broadcast(StaticPacketHelper.GenerateEff(UserType.Player, Session.Character.CharacterId, 4945), Session.Character.MapX, Session.Character.MapY);
                                }
                                else
                                    Session.SendPacket(Session.Character.GenerateSay(" you don't have 50kk", 11));
                            }
                            else
                            {
                                Session.SendPacket(Session.Character.GenerateSay("Item is not broken or not in your first inventory slot", 11));
                                return;
